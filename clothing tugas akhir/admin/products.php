                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php foreach ($products as $product): ?>
                            <tr>
                                <td>
                                    <img src="<?php echo SITE_URL; ?>/uploads/products/<?php echo htmlspecialchars($product['foto_utama']); ?>" alt="<?php echo htmlspecialchars($product['nama_produk']); ?>" class="rounded" style="width: 50px; height: 50px; object-fit: cover;">
                                </td>
                                <td>
                                    <h6 class="mb-0"><?php echo htmlspecialchars($product['nama_produk']); ?></h6>
                                </td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <button type="button" onclick="confirmDelete(<?php echo $product['id']; ?>, '<?php echo htmlspecialchars($product['nama_produk'], ENT_QUOTES, 'UTF-8'); ?>')" class="btn btn-sm btn-outline-danger">
